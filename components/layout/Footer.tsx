  ...
  return (
    <footer className="w-full bg-[#0B1C14] text-white font-sfpro">
      ...
      <div className="mt-[32px] md:mt-[45px] lg:mt-[60px] flex flex-col gap-[32px] md:gap-[40px] lg:gap-[48px]">
        ...
        {/* CONTACT INFO */}
        <div className="flex flex-col gap-[12px] md:gap-[14px] lg:gap-[16px] text-white/90">
          <a
            href="mailto:info@hypoteq.ch"
            className="flex items-center gap-[10px] md:gap-[12px] hover:text-[#CAF476] transition-colors text-[14px] md:text-[15px] lg:text-[16px]"
            aria-label="Send email to info@hypoteq.ch"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <rect x="2" y="4" width="20" height="16" rx="2"/>
              <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
            <span>info@hypoteq.ch</span>
          </a>
          <a
            href="tel:+41445544100"
            className="flex items-center gap-[10px] md:gap-[12px] hover:text-[#CAF476] transition-colors text-[14px] md:text-[15px] lg:text-[16px]"
            aria-label="Call 044 554 41 00"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
            </svg>
            <span>044 554 41 00</span>
          </a>
        </div>
